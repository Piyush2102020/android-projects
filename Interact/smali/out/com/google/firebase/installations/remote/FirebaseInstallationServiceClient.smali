...
.method private getFullyQualifiedRequestUri(Ljava/lang/String;)Ljava/net/URL;
    ...
    :try_end_1c
    .catch Ljava/net/MalformedURLException; {:try_start_0 .. :try_end_1c} :catch_1d
...
.method private openHttpURLConnection(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    :try_end_a
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_a} :catch_78
    ...
    :try_end_56
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_46 .. :try_end_56} :catch_63
    .catch Ljava/lang/InterruptedException; {:try_start_46 .. :try_end_56} :catch_57
...
.method private static readErrorResponse(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    move-result-object v1
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_14 .. :try_end_4c} :catch_59
    .catchall {:try_start_14 .. :try_end_4c} :catchall_52
...
.method public createFirebaseInstallation(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/google/firebase/installations/remote/InstallationResponse;
    ...
    move-result-object v0
    :try_end_4d
    .catch Ljava/lang/AssertionError; {:try_start_27 .. :try_end_4d} :catch_96
    .catch Ljava/io/IOException; {:try_start_27 .. :try_end_4d} :catch_94
    .catchall {:try_start_27 .. :try_end_4d} :catchall_8c
    ...
    :try_end_57
    .catch Ljava/lang/AssertionError; {:try_start_54 .. :try_end_57} :catch_96
    .catch Ljava/io/IOException; {:try_start_54 .. :try_end_57} :catch_94
    .catchall {:try_start_54 .. :try_end_57} :catchall_8c
    ...
    move-result-object v0
    :try_end_7b
    .catch Ljava/lang/AssertionError; {:try_start_6a .. :try_end_7b} :catch_96
    .catch Ljava/io/IOException; {:try_start_6a .. :try_end_7b} :catch_94
    ...
    throw v7
    :try_end_8c
    .catch Ljava/lang/AssertionError; {:try_start_82 .. :try_end_8c} :catch_96
    .catch Ljava/io/IOException; {:try_start_82 .. :try_end_8c} :catch_94
    .catchall {:try_start_82 .. :try_end_8c} :catchall_8c
...
.method public deleteFirebaseInstallation(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    throw v6
    :try_end_6c
    .catch Ljava/io/IOException; {:try_start_20 .. :try_end_6c} :catch_84
    .catchall {:try_start_20 .. :try_end_6c} :catchall_7c
...
.method public generateAuthToken(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/google/firebase/installations/remote/TokenResult;
    ...
    move-result-object v1
    :try_end_60
    .catch Ljava/lang/AssertionError; {:try_start_2a .. :try_end_60} :catch_c8
    .catch Ljava/io/IOException; {:try_start_2a .. :try_end_60} :catch_c6
    .catchall {:try_start_2a .. :try_end_60} :catchall_be
    ...
    :try_end_6b
    .catch Ljava/lang/AssertionError; {:try_start_68 .. :try_end_6b} :catch_c8
    .catch Ljava/io/IOException; {:try_start_68 .. :try_end_6b} :catch_c6
    .catchall {:try_start_68 .. :try_end_6b} :catchall_be
    ...
    move-result-object v1
    :try_end_98
    .catch Ljava/lang/AssertionError; {:try_start_87 .. :try_end_98} :catch_c8
    .catch Ljava/io/IOException; {:try_start_87 .. :try_end_98} :catch_c6
    .catchall {:try_start_87 .. :try_end_98} :catchall_be
    ...
    move-result-object v1
    :try_end_b7
    .catch Ljava/lang/AssertionError; {:try_start_9f .. :try_end_b7} :catch_c8
    .catch Ljava/io/IOException; {:try_start_9f .. :try_end_b7} :catch_c6
    .catchall {:try_start_9f .. :try_end_b7} :catchall_be
